...
- Browser extensions (included in project)

### Install from Release

1. Download the latest release from [GitHub Releases](https://github.com/N00RVL/TabSwitchCmdPal/releases)
2. Install the Command Palette extension
3. Install the native messaging host (run as Administrator): `NativeHost\install.bat`
4. Install browser extensions in Chrome/Firefox
5. Open Command Palette and search for "Open Tab"!img src="Assets/logo.png" alt="TabSwitch Logo" width="256" height="128">
...
1. Search up from cmdpal install extensions
2. Type TabSearch
3. Click Install
...
2. **Type "Open Tab"** or "TabSwitch"
3. **Search for your tab** by typing part of the page title or URL
4. **Click or press Enter** to open that tab in the browser

### Tips

- 💡 **Type partial tab names** for instant filtering
- 🔄 **Use arrow keys** to navigate through results
- ⚡ **Press Enter** to open immediately
- � **Works across all browsers** - Chrome, Firefox, Edge (Respective Browser Extensions required for this to work)
